...
import 'package:flutter_music/flutter/chewie/src/chewie_progress_colors.dart';
import 'package:flutter_music/flutter/chewie/src/player_with_controls.dart';
...
class Chewie extends StatefulWidget {
  const Chewie({Key? key, required this.controller, this.title = ""}) : super(key: key);
...
class ChewieState extends State<Chewie> {
  ...
  void onEnterFullScreen() {
    ...
    if (widget.controller.systemOverlaysOnEnterFullScreen != null) {
      ...
      SystemChrome.setEnabledSystemUIMode(SystemUiMode.manual, overlays: widget.controller.systemOverlaysOnEnterFullScreen!);
    } else {
      /// Default behavior
