...
import 'package:flutter_music/flutter/chewie/src/cupertino_progress_bar.dart';
import 'package:flutter_music/flutter/chewie/src/utils.dart';
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: AbsorbPointer(
          ...
          child: Column(
            children: <Widget>[
              chewieController.isFullScreen ? _buildHeader() : const SizedBox(),
      ...
      child: Container(
        ...
        child: Transform(
          ...
          transform: Matrix4.skewY(0.0)
            ..rotateX(math.pi)
            ..rotateZ(math.pi * 0.8),
          child: Center(child: Text("倍速", style: TextStyle(fontSize: 12.0.sp))),
        ),
      ),
    );
  }
